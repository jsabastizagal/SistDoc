<script type="text/javascript">
    $("#btnSend").click(function(){
        ...
        var hist=$("#proveido").val();
        if(hist=="")return false;
        var pathBase=pathSistdoc+"movimiento/actualizar";
        $.ajax({
            type:"post",
            url:pathBase,
            data:"id="+id_+"&proveido="+hist,
            success:function(resp){
                    alert("Proveido Agregado");
            }
        });
    });
...
<div style="padding: 1px;background-color: #515352">
    <div id="">
        <label style="float: left;font-weight: bold;text-align: center;color: #f1f0f0 ">
            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
            Proveido del Expediente <?php ?></label>
        <label style="">&nbsp;</label>
    </div>
</div>
<div style="border-top: 1px solid #a7a9a8;text-align: left">
    <div style="position: relative;top: 10px;">
        ...
        <textarea name="proveido" id="proveido" rows="4" cols="20"><?php echo $listaDatos->proveido;?></textarea>
        ...
        <?php }else{?>
        <textarea name="proveido" disabled rows="4" cols="20"><?php echo $listaDatos->proveido;?></textarea>
        <?php }?>
        </div>
    </div>
