...
<form id="frmAdd" class='form-stacked' action="" method="post">
    <input id="id_organo_administrativo" name="id_organo_administrativo" type="hidden" value="<?php echo $id_organo_administrativo; ?>">
    ...
    <table style="width: 100%">
        ...
        <tbody>
            <tr><td></td>
                <td><label for="name">Nombre de &Aacute;rea</label></td>
                <td>                    
                    <input class="xlarge" id="nombre_area" name="nombre_area" size="30" type="text" value="<?php echo $nombre_area; ?>">
                </td>
                <td></td>
            </tr>
