        ...
        ?>
            <tr>
                ...
                <td style="text-align:center">
                    <button class="btn btn-mini btnMod" type="button" attr-aux="<?php echo $val->id_tipo_documento; ?>">
                        <i class="icon-trash"></i>&nbsp Modificar</button>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                    <button class="btn btn-mini btnEli" type="button" attr-aux="<?php echo $val->id_tipo_documento; ?>">
