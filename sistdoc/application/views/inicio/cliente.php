    ...
    <body>        
        <div id="container">
            ...
            <div id="wb_Image2" style="position:absolute;left:0px;top:-14px;width:100%;height:118px;z-index:4;padding:0;">
                <img src="<?php 
                echo base_url() ?>recursos/imagenes/banner.png" id="Image2" alt="" border="0" style="width:100%;height:181px;"></div>
            <div style="position:absolute;left:1px;top:144px;width:100%;height:18px;text-align:right;z-index:6;padding:0;">
<!--                <div class="navbar navbar-inverse">-->
                <div class="navbar">
                    <div class="navbar-inner">
                        <div class="container" style="font-size: 14px;font-family: Helvetica,Arial,sans-serif">
                            <a href="<?php echo base_url() ?>" class="brand">SISTDOC</a>
                            <ul class="nav">
                                <li class="<?php echo ($opcion == 1) ? "active" : "" ?>"><a href="<?php echo base_url() ?>">Salir</a></li>
                            </ul>
                        </div>
                    </div>
                </div>
            ...
            <div id="wb_Shape1" style="position:relative;left:1px;top:185px;width:100%;z-index:0;padding:0;">
                <img src="<?php echo base_url() ?>recursos/imagenes/bg_white.gif" id="Shape1" alt="" title="" style="border-width:0;width:100%;height:70%;">
                <?php echo $estructura ?>
            </div>            
        </div>
